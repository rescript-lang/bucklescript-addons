...
'use strict';
define(["exports", "bs-platform/lib/amdjs/caml_builtin_exceptions", "bs-platform/lib/amdjs/pervasives", "bs-platform/lib/amdjs/string"],
  function(exports, Caml_builtin_exceptions, Pervasives, $$String){
    'use strict';
    ...
    function find(x, _param) {
      while(true) {
        var param = _param;
        if (param) {
          var c = $$String.compare(x, param[1]);
          if (c) {
    ...
    function compare(cmp, m1, m2) {
      ...
      while(true) {
        ...
        if (e1) {
          if (e2) {
            var c = $$String.compare(e1[0], e2[0]);
            if (c !== 0) {
              return c;
            }
            else {
